...
function PageView() {
  ...
  return (
    <article className="mx-auto max-w-2xl px-6 py-12">
      ...
      <div
        className="prose prose-lg max-w-none prose-headings:text-foreground prose-p:text-foreground/90 prose-a:text-primary prose-a:no-underline hover:prose-a:underline prose-blockquote:not-italic prose-img:rounded-lg"
